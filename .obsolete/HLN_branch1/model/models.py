...
class HLN_branch1(torch.nn.Module):
    def __init__(self, num_classes=[6,18,128]):
        super().__init__()
        self.name = "HLN_branch1"
        ...
        self.txt_cntvector_main1 = torch.nn.Linear(CFG["embedding_dim"], 2048)
        self.txt_cntvector_main2 = torch.nn.Linear(2048, 2048)
        # self.txt_cntvector_main3 = torch.nn.Linear(2048, 1440)
        
        self.txt1_cntvector_branch1 = torch.nn.Linear(2048, 512)
        # self.txt2_cntvector_branch1 = torch.nn.Linear(2048, 1024)
        # self.txt3_cntvector_branch1 = torch.nn.Linear(2048, 2048)
        
        self.txt1_cntvector_branch2 = torch.nn.Linear(512, self.cat1_dim)
        # self.txt2_cntvector_branch2 = torch.nn.Linear(1024, self.cat2_dim)
        # self.txt3_cntvector_branch2 = torch.nn.Linear(2048, self.cat3_dim)
    ...
    def forward(self, x_img, x_txt_cntvector):
        ...
        x_txt_cntvector  = self.txt_cntvector_main1(x_txt_cntvector)
        x_txt_cntvector  = self.activate(x_txt_cntvector)
        x_txt_cntvector  = self.dropout(x_txt_cntvector)

        x_txt_cntvector  = self.txt_cntvector_main2(x_txt_cntvector)
        x_txt_cntvector  = self.activate(x_txt_cntvector)
        x_txt_cntvector  = self.dropout(x_txt_cntvector)

        # x_txt_cntvector  = self.txt_cntvector_main3(x_txt_cntvector)
        # x_txt_cntvector  = self.activate(x_txt_cntvector)
        # x_txt_cntvector  = self.dropout(x_txt_cntvector)

        # branch networks 
        txt_cnt_level_1 = self.txt1_cntvector_branch1(x_txt_cntvector)
        txt_cnt_level_1 = self.activate(txt_cnt_level_1)

        txt_cnt_level_1 = self.txt1_cntvector_branch2(txt_cnt_level_1)
        txt_cnt_level_1 = self.activate(txt_cnt_level_1)

        # txt_cnt_level_2 = self.txt2_cntvector_branch1(x_txt_cntvector)
        # txt_cnt_level_2 = self.activate(txt_cnt_level_2)

        # txt_cnt_level_2 = self.txt2_cntvector_branch2(txt_cnt_level_2)
        # txt_cnt_level_2 = self.activate(txt_cnt_level_2)

        # txt_cnt_level_3 = self.txt3_cntvector_branch1(x_txt_cntvector)
        # txt_cnt_level_3 = self.activate(txt_cnt_level_3)
        
        # txt_cnt_level_3 = self.txt3_cntvector_branch2(txt_cnt_level_3)
        # txt_cnt_level_3 = self.activate(txt_cnt_level_3)
