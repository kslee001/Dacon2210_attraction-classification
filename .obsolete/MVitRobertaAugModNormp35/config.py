...
seed_number = 33
folder_name = f"MVitRobertaAugModNormp35"
...
inference_config = {
    ...
    "weight_dir" : f"/home/gyuseonglee/dacon/workplace/output/{folder_name}{seed_number}/{folder_name}{seed_number}state_dicts",
