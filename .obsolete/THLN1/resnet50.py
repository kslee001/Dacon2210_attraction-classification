...
class ResNet50(nn.Module):
    ...
    def __init__(self, use_cbam=True, image_depth=3, num_classes=[6,18,128]):
        ...
        self.softmax_reg3 = nn.Linear(num_classes[0]+num_classes[1]+num_classes[2], num_classes[2])
    ...
    def forward(self, x):
        ...
        level_3 = self.softmax_reg3(torch.cat((level_1, self.linear_lvl2(x), self.linear_lvl3(x)), dim=1))
