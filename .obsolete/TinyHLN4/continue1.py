# config & dataset
import os
os.chdir("/home/gyuseonglee/dacon/workplace/TinyHLN4")

from config import *
import preprocessing
import functions_continue1 as functions
from models import *
...
if __name__ == "__main__":
    ...
    P = [__param1, __param2, __param3]#, __param12, __param23]
    ...
    model.load_state_dict(torch.load(output_folder + "/" + model_states_name))
    model.eval()
