...
import os
os.chdir("..")
from __continue1.config_continue1 import *
import __continue1.train_continue1 as functions
...
if __name__ == "__main__":
    ...
    # define model
    model     = TinyHierachicalLossNetwork().cuda()
   ...
   # parallelize model
    ...
    end_time = t.time()
    duration = (end_time-start_time)*3000
