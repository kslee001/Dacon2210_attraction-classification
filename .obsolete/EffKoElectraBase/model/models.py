...
class EffKoElectraBase(torch.nn.Module):
    def __init__(self, num_classes=[6,18,128]):
        super().__init__()
        self.name = "EffKoElectraBase"
        ...
        """text classifier"""
        self.txt_main = AutoModel.from_pretrained("monologg/koelectra-base-v3-discriminator")
        # self.txt_main_cfr = torch.nn.Linear(768, self.txt_dim)
