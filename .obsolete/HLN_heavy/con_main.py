...
import con_functions.preprocessing as preprocessing
import con_functions.train as train
...
if __name__ == "__main__":
    # try:
    print(f"job started -- current model : {folder_name}_{contin_iter}")
    start_time = t.time()
    ...
    # parallelize model & load weights
