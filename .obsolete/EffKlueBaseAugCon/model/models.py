...
class EffKlueBaseAugCon(torch.nn.Module):
    def __init__(self, num_classes=[6,18,128]):
        super().__init__()
        self.name = "EffKlueBaseAugCon"
    ...
    def forward(self, img, txt_input_ids, txt_attention_mask):
        ...
        txt = self.txt_main(txt_input_ids, txt_attention_mask).last_hidden_state[:, 0, :] #CLS     # B, 256, 768 -> B, 256 * 768
